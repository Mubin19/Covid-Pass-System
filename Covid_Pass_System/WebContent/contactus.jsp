...
<head>
    ...
    <title>Online Photography Portfolio</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="logo">
                        <a href="./index.html">
                            <h2>Online <span></span></h2>
							<h2>Photography <span></span></h2>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact-text">
                        ...
                        <div class="ct-item">
                            ...
                            <div class="ct-text">
                                <h5>Email</h5>
                                <p>ONLINE123.photography@ gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
